...
Row {
    Image(painter = painterResource(id = R.drawable.siberian),
        contentDescription ="",
    ...
    Spacer(modifier = Modifier.width(20.dp))
        ...
        Column {
            ...
            Text(text = "Having a Siberian Husky means you need to double-check your locks to make sure they can’t escape. Huskies want to explore the world outside, and they’ll try all sorts of ways to break out of your house or yard. ")  }
}
