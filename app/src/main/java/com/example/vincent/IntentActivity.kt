    ...
    Column(modifier = Modifier
        ...
        TopAppBar(
            ...
            navigationIcon = {
                ...
                IconButton(onClick = {
                               mContext.startActivity(Intent(mContext,VyKotlin::class.java))
        ...
        OutlinedButton(
            ...
            Text(text = "MPESA", color = Color.Yellow)
        ...
        OutlinedButton(
            ...
            Text(text = "CAMERA", color = Color.Yellow)
        ...
        OutlinedButton(
            ...
            Text(text = "EMAIL", color = Color.Yellow)
        ...
        OutlinedButton(
            ...
            Text(text = "SMS", color = Color.Yellow)
        ...
        OutlinedButton(
            ...
            Text(text = "CALL", color = Color.Yellow)
        ...
        OutlinedButton(
            ...
            Text(text = "SHARE", color = Color.Yellow)
